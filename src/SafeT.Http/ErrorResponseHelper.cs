...
namespace SafeT.Http
{
    public static class ErrorResponseHelper
    {
        ...
        public static Error EnhanceYourCalm(string message, object content = null, params object[] offenders)
        {
            return new Error() { StatusCode = 420, Message = message, Content = content, Offenders = offenders };
        }

        public static Safe<T> EnhanceYourCalm<T>(string message, object content = null, params object[] offenders)
        {
            return EnhanceYourCalm(message, content, offenders);
        }
