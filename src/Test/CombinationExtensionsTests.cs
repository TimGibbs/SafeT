...
namespace Test
{
    public class CombinationExtensionsTests
    {
        ...
        {
            // Arrange
            IEnumerable<Safe<int>> items = new[] { Safe<int>.Error(new Error(){ Message = "abc", StatusCode = 400 }), Safe<int>.Ok(17) };
            string defaultMessage = null;
            int defaultStatusCode = 0;
        ...
        {
            // Arrange
            IEnumerable<Safe<int>> items = new[] { Safe<int>.Error(new Error() { Message = "abc", StatusCode = 400 }), Safe<int>.Error(new Error() { Message = "abc", StatusCode = 401 }) };
            string defaultMessage = null;
            int defaultStatusCode = 0;
        ...
        {
            // Arrange
            IEnumerable<Safe<IEnumerable<int>>> items = new[] { Safe<IEnumerable<int>>.Error(new Error() { Message = "abc", StatusCode = 400 }), Safe<IEnumerable<int>>.Ok(new[] { 17 }) };
            string defaultMessage = null;
            int defaultStatusCode = 0;
        ...
        {
            // Arrange
            IEnumerable<Safe<IEnumerable<int>>> items = new[] { Safe<IEnumerable<int>>.Error(new Error() { Message = "abc", StatusCode = 400 }), Safe<IEnumerable<int>>.Error(new Error() { Message = "abc", StatusCode = 401 }) };
            string defaultMessage = null;
            int defaultStatusCode = 0;
